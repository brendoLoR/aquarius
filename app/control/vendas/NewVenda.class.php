...
/**
    ...
    class NewVenda extends TWindow
    {
        ...
        function __construct()
        {
            ...
            // detalhe fields
            $venda_id = $id->getValueToString();
            $produto_detalhe_unqid      = new THidden('produto_detalhe_uniqid');
            $produto_detalhe_id         = new THidden('produto_detalhe_id');
            ...
            $this->form->addFields( [new TLabel('ID')], [$id], 
                                    [new TLabel('Data da Entrega (*)', '#FF0000')], [$date] );
            ...
            $this->form->addFields( [ $produto_detalhe_unqid], [$produto_detalhe_id], [$produto_detalhe_name] );

            $this->form->addFields( [ new TLabel('produto (*)', '#FF0000') ], [$produto_detalhe_produto_id],
                                    [ new TLabel('quantidade(*)', '#FF0000') ],   [$produto_detalhe_quantidade],
                                    [ new TLabel('Tamanho(*)', '#FF0000') ],  [$tamanho_produto_detalhe_id]
                                    );

            $this->form->addFields( [ new TLabel('preço (*)', '#FF0000') ],   [$produto_detalhe_preco],
            ...
            $this->produto_list->addAction($action1, _t('Edit'), 'far:edit blue');
            $this->produto_list->addAction($action2, _t('Delete'), 'far:trash-alt red');
        ...
        public static function onProdutoChange( $params )
        {
            if( !empty($params['produto_detalhe_produto_id']) )
            {
                try
                {
                    ...
                    TForm::sendData('form_venda', (object) ['produto_detalhe_preco' => $produto->preco ]);
                    TForm::sendData('form_venda', (object) ['produto_detalhe_name' => $produto->nome_produto ]);
        ...
        public function onProdutoAdd( $param )
        {
            try
            {
                ...
                TDataGrid::replaceRowById('produtos_list', $uniqid, $row);

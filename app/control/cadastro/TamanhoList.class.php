    ...
    class TamanhoList extends TPage
    {
        protected $form;      // form
        ...
        public function __construct()
        {
            ...
            $this->setActiveRecord('Tamanho'); // define the Active Record
            $this->setDefaultOrder('id', 'asc'); // define the default order
            $this->setLimit(-1); // turn off limit for datagrid
            
            // create the form
            $this->form = new BootstrapFormBuilder('form_categories');
            $this->form->setFormTitle('Listagem de Tamanhos para camisetas');
            ...
            $this->form->addFields( [new TLabel('Tamanho', 'red')],  [$tamanho] );
            ...
            $col_tamanho  = new TDataGridColumn('tamanho', 'tamanho', 'left', '90%');
            
            $this->datagrid->addColumn($col_id);
            $this->datagrid->addColumn($col_tamanho);
            
            $col_id->setAction( new TAction([$this, 'onReload']),   ['order' => 'id']);
            $col_tamanho->setAction( new TAction([$this, 'onReload']), ['order' => 'tamanho']);

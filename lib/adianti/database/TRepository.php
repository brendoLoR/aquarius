...
class TRepository
{
     ...
     * @param  $end = final valur
     * @param  $logicOperator = logical operator (TExpression::AND_OPERATOR, TExpression::OR_OPERATOR)
     * @return A TRepository object
     */
    public function between($variable, $init, $end, $logicOperator = TExpression::AND_OPERATOR)
    {
        $this->criteria->add(new TFilter($variable, 'BETWEEN', $init, $end), $logicOperator);
